...
Convergencia estable: la pérdida decrece de forma mayoritariamente monótona a lo largo del entrenamiento, con pequeñas oscilaciones esperables con Adam. [file:2]

Poca diferencia de MSE final entre el modelo completo y los simplificados, lo que indica que, para el dataset y la configuración usados, incluso arquitecturas con menos filtros aproximan bien la máscara. [file:2]
